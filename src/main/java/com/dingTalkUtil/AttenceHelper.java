...
public class AttenceHelper {
    ...
    //获取企业考勤排班详情
    public OapiAttendanceListscheduleResponse.AtScheduleListForTopVo getAttendanceList(String accessToken){
        try {
    ...
    //获取企业考勤组详情
    public OapiAttendanceGetsimplegroupsResponse.AtGroupListForTopVo getAttendanceSimpleGruop(String accessToken){
        try{
    ...
    //获取打卡详情
    public List getAttendanceListRecord(String accessToken,String dateFrom,String dateTo,String userIdList){
        try{
    ...
    //获取打卡结果
    public List getAttendanceResult(String accessToken,String dateFrom,String dateTo,String userIdList){
        try{
    ...
    //获取请假时长
    public Long getLeaveTime(String accessToken,String userId,String dateFrom,String dateTo){
        try{
    ...
    //获取用户考勤组
    public OapiAttendanceGetusergroupResponse.AtGroupFullForTopVo getUserAttendanceGruop(String accessToken, String userId){
        try{
